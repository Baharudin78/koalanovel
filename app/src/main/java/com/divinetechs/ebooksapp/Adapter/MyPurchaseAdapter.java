...
public class MyPurchaseAdapter extends RecyclerView.Adapter<MyPurchaseAdapter.MyViewHolder> {
    ...
    public MyPurchaseAdapter(Context context, List<Result> downloadList, String from,
                             String where, ItemClick itemClick, String currency_symbol) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_transaction_item, parent, false);
