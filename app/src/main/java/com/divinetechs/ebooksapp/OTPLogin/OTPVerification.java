...
public class OTPVerification extends AppCompatActivity implements CountdownView.OnCountdownEndListener {
    ...
    LinearLayout lyResendOTP, lyBack;
    EditText etOTP;
    TextView txtVerifyProceed;
    CountdownView countdownTimer;

    String entryFrom = "", strMobile = "", strEmail = "", strUserName = "", strOTP, strDeviceToken, verificationId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.screenCapOff(OTPVerification.this);
    ...
    private void SignInMobile() {
        ...
        Call<LoginRegiModel> call = bookNPlayAPI.loginwithotp(strMobile);
    ...
    private void UpdateMissingProfile() {
        ...
        AppAPI bookNPlayAPI = BaseURL.getVideoAPI();
        Call<SuccessModel> call = bookNPlayAPI.updateMissingData("" + prefManager.getLoginId(), "" + strUserName, "" + strEmail, "" + strMobile);
