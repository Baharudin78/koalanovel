...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.screenCapOff(WelcomeActivity.this);
        Utils.HideNavigation(WelcomeActivity.this);
    ...
    private void launchHomeScreen() {
        startActivity(new Intent(WelcomeActivity.this, com.divinetechs.ebooksapp.Activity.LoginActivity.class));
        finish();
    }
