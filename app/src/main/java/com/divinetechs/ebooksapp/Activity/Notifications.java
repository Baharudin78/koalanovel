...
import com.divinetechs.ebooksapp.Adapter.NotificationAdapter;
import com.divinetechs.ebooksapp.Model.NotificationModel.NotificationModel;
import com.divinetechs.ebooksapp.Model.NotificationModel.Result;
...
public class Notifications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.screenCapOff(Notifications.this);
        ...
        ItemTouchHelper.SimpleCallback callback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT | ItemTouchHelper.LEFT) {
            ...
            public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                new RecyclerViewSwipeDecorator.Builder(c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
                        .addSwipeLeftBackgroundColor(ContextCompat.getColor(Notifications.this, R.color.green))
                        .addSwipeLeftActionIcon(R.drawable.ic_checked_24)
                        .addSwipeRightBackgroundColor(ContextCompat.getColor(Notifications.this, R.color.green))
                        .addSwipeRightActionIcon(R.drawable.ic_checked_24)
    ...
    private void ReadNotification(String ID) {
        ...
        AppAPI bookNPlayAPI = BaseURL.getVideoAPI();
        Call<SuccessModel> call = bookNPlayAPI.read_notification("" + prefManager.getLoginId(), "" + ID);
