...
import com.divinetechs.ebooksapp.Utility.ScalingUtilities;
...
public class Profile extends AppCompatActivity {
    ...
    LinearLayout lyBack, lyPassVisibility, lyImgEdit;
    TextView txtUpdate, txtPassVisible;
    EditText etEmail, etPhoneNumber, etUsername, etPassword;

    List<Result> profileList;

    String strUsername, strPassword, strEmail, strMobileNumber, fileProfile = "", entryFrom = "";
    RequestBody userId, email, fullname, mobileNumber, password;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Utils.screenCapOff(Profile.this);
        ...
        lyPassVisibility.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(etPassword.getText().toString())) {
                    Toasty.warning(Profile.this, "" + getResources().getString(R.string.enter_password), Toasty.LENGTH_SHORT).show();
                    return;
                }
        ...
        lyBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (entryFrom.equalsIgnoreCase("OTP")) {
                    startActivity(new Intent(Profile.this, com.divinetechs.ebooksapp.Activity.MainActivity.class));
                }
                finish();
            }
        });
    ...
    private void AddProfileImg(String filePath) {
        ...
        AppAPI bookNPlayAPI = BaseURL.getVideoAPI();
        Call<SuccessModel> call = bookNPlayAPI.add_profile_img(userId, fullname, email, password, mobileNumber, body);
    ...
    private void ProfileUpdate() {
        ...
        AppAPI bookNPlayAPI = BaseURL.getVideoAPI();
        Call<SuccessModel> call = bookNPlayAPI.updateprofile("" + prefManager.getLoginId(),
