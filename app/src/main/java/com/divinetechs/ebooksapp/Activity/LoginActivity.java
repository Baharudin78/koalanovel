...
import com.divinetechs.ebooksapp.OTPLogin.SendOTP;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    LinearLayout lyGmail, lyFacebook, lyOTPLogin;
    ...
    String str_firstname, str_lastname, fb_name, fb_email, str_email, str_password, str_type, storeImageName = "", loginWith = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.screenCapOff(LoginActivity.this);
    ...
    private void Init() {
        try {
            ...
            txt_already_signup.setOnClickListener(this);
    ...
    private void SignIn() {
        ...
        Call<LoginRegiModel> call = bookNPlayAPI.login(str_email, str_password, str_type);
            ...
            public void onResponse(Call<LoginRegiModel> call, Response<LoginRegiModel> response) {
                ...
                try {
                    if (response.code() == 200 && response.body().getStatus() == 200) {
                        ...
                        Toasty.success(LoginActivity.this, "" + response.body().getMessage(), Toasty.LENGTH_SHORT).show();
    ...
    private void SignInSocial() {
        ...
        AppAPI bookNPlayAPI = BaseURL.getVideoAPI();
        Call<LoginRegiModel> call = bookNPlayAPI.login(first_name, last_name, email, type, mobile_number, password, body);
        call.enqueue(new Callback<LoginRegiModel>() {
            @Override
            public void onResponse(Call<LoginRegiModel> call, Response<LoginRegiModel> response) {
                Utils.ProgressbarHide();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.txt_already_signup:
                startActivity(new Intent(LoginActivity.this, com.divinetechs.ebooksapp.Activity.Registration.class));
                break;
            ...
            case R.id.txt_forgot:
                startActivity(new Intent(LoginActivity.this, com.divinetechs.ebooksapp.Activity.ForgotActivity.class));
                break;
        }
    }
        ...
        GraphRequest request = GraphRequest.newMeRequest(accessToken, new GraphRequest.GraphJSONObjectCallback() {
            ...
            public void onCompleted(JSONObject object, GraphResponse response) {
                ...
                if (object != null) {
                    ...
                    storeImageName = "" + fb_name.replaceAll("[, ;]", "").toLowerCase();
                    Log.e("facebook", "image_url => " + image_url);
                    if (image_url != null) {
                        downloadAndSave(LoginActivity.this, image_url, getResources().getString(R.string.app_name) + storeImageName);
                    } else {
                        SignInSocial();
                    }
                }
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            type = RequestBody.create(MediaType.parse("text/plain"), "4");
            mobile_number = RequestBody.create(MediaType.parse("text/plain"), "");
            password = RequestBody.create(MediaType.parse("text/plain"), "");

            storeImageName = "" + str_firstname;
            if (account.getPhotoUrl() != null) {
                downloadAndSave(LoginActivity.this, "" + account.getPhotoUrl(), getResources().getString(R.string.app_name) + storeImageName);
            } else {
                SignInSocial();
            }
