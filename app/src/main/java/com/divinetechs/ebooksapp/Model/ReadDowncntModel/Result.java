...
public class Result {
    ...
    @SerializedName("totla_download")
    @Expose
    private String totlaDownload;
    ...
    public String getTotlaDownload() {
        return totlaDownload;
    }

    public void setTotlaDownload(String totlaDownload) {
        this.totlaDownload = totlaDownload;
    }
